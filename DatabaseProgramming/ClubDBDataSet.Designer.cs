...
namespace DatabaseProgramming.ClubDBDataSetTableAdapters {
    ...
    public partial class ClubMembersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[ClubMembers] WHERE (([ID] = @Original_ID) AND ([StudentID] = @Original_StudentID) AND ([FirstName] = @Original_FirstName) AND ([MiddleName] = @Original_MiddleName) AND ([LastName] = @Original_LastName) AND ([Age] = @Original_Age) AND ([Gender] = @Original_Gender) AND ([Program] = @Original_Program))";
...
SELECT ID, StudentID, FirstName, MiddleName, LastName, Age, Gender, Program FROM ClubMembers WHERE (ID = @ID)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[ClubMembers] SET [ID] = @ID, [StudentID] = @StudentID, [FirstName] = @FirstName, [MiddleName] = @MiddleName, [LastName] = @LastName, [Age] = @Age, [Gender] = @Gender, [Program] = @Program WHERE (([ID] = @Original_ID) AND ([StudentID] = @Original_StudentID) AND ([FirstName] = @Original_FirstName) AND ([MiddleName] = @Original_MiddleName) AND ([LastName] = @Original_LastName) AND ([Age] = @Original_Age) AND ([Gender] = @Original_Gender) AND ([Program] = @Original_Program));
SELECT ID, StudentID, FirstName, MiddleName, LastName, Age, Gender, Program FROM ClubMembers WHERE (ID = @ID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::DatabaseProgramming.Properties.Settings.Default.ClubDBConnectionString;
        }
        ...
        public virtual int Delete(int Original_ID, long Original_StudentID, string Original_FirstName, string Original_MiddleName, string Original_LastName, int Original_Age, string Original_Gender, string Original_Program) {
            ...
            if ((Original_Program == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[7].Value = ((string)(Original_Program));
            }
        ...
        public virtual int Insert(int ID, long StudentID, string FirstName, string MiddleName, string LastName, int Age, string Gender, string Program) {
        ...
        public virtual int Update(
            ...
            if ((Original_Program == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[15].Value = ((string)(Original_Program));
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(long StudentID, string FirstName, string MiddleName, string LastName, int Age, string Gender, string Program, int Original_ID, long Original_StudentID, string Original_FirstName, string Original_MiddleName, string Original_LastName, int Original_Age, string Original_Gender, string Original_Program) {
